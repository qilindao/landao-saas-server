...
class MenuRequest extends BaseRequest
{
    public function getRulesByStore(): array
    {
        return [
            ...
            'type' => ['required', Rule::in(MenuTypeEnum::getValues())],
            'path' => Rule::requiredIf(function () {
                return intval(request()->input('type')) == MenuTypeEnum::MENU_TYPE_CATALOG->value;
            }),//type = 1 时，菜单路由的路径
            'component' => Rule::requiredIf(function () {//目录和菜单时，必须填写 组件名
                return in_array(intval(request()->input('type')), [MenuTypeEnum::MENU_TYPE_CATALOG->value, MenuTypeEnum::MENU_TYPE_MENU->value]);
            }),
