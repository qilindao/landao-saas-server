...
//            $table->string('module', 10)->default('ADMIN')->comment('所属前端');
            $table->unsignedTinyInteger('type')->default('0')->index('idx_sys_menu_type')->comment('菜单类型[0:目录;1:菜单;2:权限]');
        ...
        //表注释
        DB::statement("ALTER TABLE `sys_menu` comment 'B端菜单权限表'");
        //主键列自增id
        DB::statement("ALTER TABLE `sys_menu` AUTO_INCREMENT=1001");
    }
