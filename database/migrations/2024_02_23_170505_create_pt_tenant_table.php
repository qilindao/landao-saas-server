...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('pt_tenant', function (Blueprint $table) {
            ...
            $table->string('domain')->unique('uk_tenant_domain')->default('');
            $table->string('database')->unique('uk_tenant_database');
        ...
        //表注释
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_tenant` comment '系统租户'");
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_tenant` AUTO_INCREMENT=1001");
    }
