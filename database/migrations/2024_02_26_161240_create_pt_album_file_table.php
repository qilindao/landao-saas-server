...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //表注释
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_album_file` comment '附件详细信息'");
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_album_file` AUTO_INCREMENT=1001");
    }
