...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //表注释
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_user_post` comment '部门'");
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_user_post` AUTO_INCREMENT=1001");
    }
