...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //表注释
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `sys_operate_log` comment '操作日志记录'");
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `sys_operate_log` AUTO_INCREMENT=1001");
    }
