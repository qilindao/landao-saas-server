...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //表注释
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `sys_dict` comment '字典类型'");
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `sys_dict` AUTO_INCREMENT=1001");
    }
