...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        //表注释
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_tenant_package` comment '租户套餐'");
        \Illuminate\Support\Facades\DB::statement("ALTER TABLE `pt_tenant_package` AUTO_INCREMENT=1001");
    }
